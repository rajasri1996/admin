...
import userdatatable from "layouts/authentication/error/userdatatable";
        ...
        <DashboardLayout>
                        ...
                        <SuiBox width="100%">
                            <AppBar position="static">
                                <Tabs orientation={tabsOrientation} value={camera} onChange={handleSetCamera}>
                                    ...
                                    <Tab label="AUM (Scheme Type Wise) " style={{ fontWeight: "bold", fontSize: "18px", margin: '10px' }} />
            ...
            <SuiBox style={{ marginTop: '20px' }}>
                <Card id="change-password">
                    <SuiBox p={1}>
                        <DataTable table={userdatatable} entriesPerPage={false} />
                    </SuiBox>
                </Card>
            </SuiBox>
