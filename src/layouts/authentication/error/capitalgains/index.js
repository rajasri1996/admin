...
function IdCell({ id, checked }) {
    ...
    const passwordRequirements = [
        ...
        " Investments in mutual funds are subject to market risks and the NAV of the schemes may change accordingly.",

        " This statement is based on the information available with us from Mutual Fund Registrars, and is only for your reference. The statement from the respective AMC reflects the exact information for the respective folio. In case of any discrepancy, please report to us.",

        " Tax is payable on your capital gains as per Income Tax Act. Please contact your Chartered Account/Tax Consultant for the same. You can contact us for any further assistance.",
